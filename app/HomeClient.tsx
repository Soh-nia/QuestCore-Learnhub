...
export default function HomeClient({ categories, initialCoursesByCategory, enrolledCourses }: HomeClientProps) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div>
            ...
            {loading ? (
              ...
              <div className="text-center text-gray-600 font-bold text-1xl my-5">
