        ...
        <div className="mt-7 bg-white border border-gray-200 rounded-xl shadow-2xs dark:bg-neutral-900 dark:border-neutral-700">
          <div className="p-4 sm:p-7">
            <div className="text-center">
              <h1 className="block text-3xl font-bold text-gray-800 dark:text-white">Sign In</h1>
              <p className="mt-2 text-sm text-gray-600 dark:text-neutral-400">
                Don’t have an account?{' '}
                <Link className="text-cyan-600 decoration-2 hover:underline focus:outline-hidden focus:underline font-medium dark:text-cyan-500" href="/auth/signup/student">
                  Sign up as Student
                </Link>
                {' or '}
                <Link className="text-cyan-600 decoration-2 hover:underline focus:outline-hidden focus:underline font-medium dark:text-cyan-500" href="/auth/signup/instructor">
                  Instructor
                </Link>
              </p>
            </div>
                ...
                <div className="grid gap-y-4">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      />
                      {errors.email && <p className="text-red-500 text-sm mt-2" id="email-error">{errors.email.message}</p>}
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="relative">
                      ...
                      >
                        {showPassword ? <IoEyeOffOutline className="shrink-0 size-3.5" /> : <IoEyeOutline className="shrink-0 size-3.5" />}
                      </button>
                    </div>
                    {errors.password && <p className="text-red-500 text-sm mt-2" id="password-error">{errors.password.message}</p>}
                  </div>
                  <button
                    type="submit"
