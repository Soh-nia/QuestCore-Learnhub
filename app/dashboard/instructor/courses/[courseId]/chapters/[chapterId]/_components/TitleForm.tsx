...
const TitleForm = memo(function TitleForm({ initialData, chapterId, courseId }: TitleFormProps) {
  ...
  return (
    <div className="mt-6 border-neutral-200 bg-neutral-50 rounded-md p-4">
      <div className="flex justify-between items-center mb-3">
        <span className="text-sm font-medium text-gray-800 dark:text-neutral-200">Chapter Title</span>
        <button
          onClick={toggleEdit}
      ...
      {!isEditing && (
        <p className="text-sm mt-2 text-gray-800 dark:text-neutral-200">{initialData.title || "No title set"}</p>
      )}
      {isEditing && (
