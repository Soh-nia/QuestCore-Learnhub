...
import { type State, updateChapter, invalidateChapterCache } from "@/app/lib/action"
...
const VideoForm = memo(function VideoForm({ initialData, courseId, chapterId }: VideoFormProps) {
    ...
    <div className="mt-6 border-neutral-200 bg-neutral-50 rounded-md p-4 dark:border-neutral-700 dark:bg-neutral-800">
      ...
      {!isEditing && !initialData.videoUrl ? (
        ...
        <div className="relative aspect-video mt-2">
          <video className="w-full h-full rounded-md" controls poster={"/placeholder-video-thumbnail.jpg"}>
      ...
      {isEditing && (
        <div>
          ...
          {isPending && <div className="text-sm text-gray-600 dark:text-neutral-400 mt-2">Uploading and saving...</div>}
          <div id="video-error" aria-live="polite" aria-atomic="true">
